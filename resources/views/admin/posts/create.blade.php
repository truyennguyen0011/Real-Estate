...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-2 mb-3">Đăng tin</h4>

                    <div>
                        <form class="form-horizontal needs-validation" novalidate action="{{ route("admin.$table.store") }}"
                            spellcheck="false" method="post" id="form-create-post">
                            @csrf
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" data-toggle="maxlength" class="form-control" minlength="20"
                                            maxlength="10000" rows="3" placeholder="Nhập mô tả" required>{{ old('description') }}</textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="direction" name="direction"
                                            value="{{ old('direction') }}" placeholder="Nhập hướng">
                                        {{-- <div class="invalid-feedback">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="area" name="area"
                                            value="{{ old('area') }}" placeholder="Nhập diện tích" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="address" maxlength="255"
                                            name="address" value="{{ old('address') }}" placeholder="Nhập dịa chỉ"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="name_seller" name="name_seller"
                                            value="{{ $user->name ?? '' }}" placeholder="Nhập họ/tên" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            {{-- Image youtube video --}}
                                            <img id="img-youtube" style="display: none" width="100%" height="auto"
                                                title="Image video" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-0 pt-3 text-center">
                                <button id="btn-submit-post" class="btn btn-primary" type="button"> Hoàn thành </button>
                            </div>
                        </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="success-header-modalLabel">Nhập Video Youtube</h4>
