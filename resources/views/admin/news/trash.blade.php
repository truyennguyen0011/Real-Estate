            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        @if ($data->count() == 0)
                            <a class="btn btn-primary" href="{{ route("admin.$table.index") }}">Quản lý tin tức</a>
                                                ...
                                                @isset($each->image_thumb)
                                                    ...
                                                    @else
                                                        <div class="position-relative">
                                                            ...
                                                            <img width="100" height="100"
                                                                src="{{ asset(config('app.image_new_thumb_direction')) . '/' . $each->image_thumb }}"
                                            ...
                                            <td class="table-action">
                                                <div class="d-flex">
                                                    ...
                                                    <form class="d-inline-block"
                                                        ...
                                                        @method('DELETE')
                                                        <button
                                                            onclick="return confirm('Bạn có chắc muốn xóa vĩnh viễn tin tức này không?')"
